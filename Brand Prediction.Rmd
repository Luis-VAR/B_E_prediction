...
#shuffling the data to ensure randomization

completeResponsesshuffle <- sample(nrows(completeResponses))
completeResponses <- completeResponses[completeResponsesshuffle, ]

incompleteResponsesshuffle <- sample(nrows(incompleteResponses))
incompleteResponses <- incompleteResponses[incompleteResponsesshuffle, ]
